/**
 * LinkedIn Scraper Service for Railway Deployment
 * 
 * This service scrapes LinkedIn profiles using Puppeteer and provides
 * a REST API for the ideate-sustainably application.
 */
...
app.get('/', (req, res) => {
  res.json({ 
    status: 'healthy',
    service: 'LinkedIn Scraper Service',
    version: '1.0.0',
    timestamp: new Date().toISOString(),
...
app.get('/test', (req, res) => {
  res.json({
    message: 'LinkedIn Scraper Service is running!',
    environment: {
